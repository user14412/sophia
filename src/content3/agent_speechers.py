...
def get_script(
    ...
    for idx1, topic in enumerate(topic_plan):
        ...
        for idx2, stage in enumerate(director_plan[idx1]['stages']):
            for idx3, bullet in enumerate(stage['bullets']):
                ...
                current_task = CurrentTask(
                    ...
                    stage_plan=director_plan[idx1]['stages'],
